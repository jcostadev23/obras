...
export default function Getpeople() {
    ...
    return <Layout>
        ...
        <Collection color="black" items={people} isPaginated itemsPerPage={10} isSearchable >
            {(person) => {
                return <Grid class="middle-block px-6 py-6 mt-5 align-middle transition-all border-2 rounded-lg  bg-gradient-to-tl from-gray-400 to-gray-700 "
                >
                    <Card class="middle-block px-6 py-3 mt-5 transition-all border-2 rounded-lg  bg-gradient-to-tl from-gray-400 to-gray-700 "
        ...
        <Button link={"/people/create/"} text={"Create people"} />
