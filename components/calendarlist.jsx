...
export default function CalendarList({ days, children }) {
    return (
        <Collection items={days} isPaginated itemsPerPage={10} isSearchable>
            {(day) => {
                return <Grid className="middle-block px-6 py-6 mt-5 align-middle transition-all border-2 rounded-lg  bg-gradient-to-tl from-gray-400 to-gray-500 shadow-lg">
                    <Card variation="elevated" key={day.id} className="middle-block px-6 py-6 mt-5 align-middle transition-all  rounded-lg  bg-gradient-to-tl from-gray-300 to-gray-400">
                        <Heading className="text-3xl text-center my-5 font-bold">{day.day}</Heading>
